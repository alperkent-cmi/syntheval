...
| `equal_opportunity` | Equal Opportunity Difference | [EqualOpportunity](src\syntheval\metrics\fairness\metric_equal_opportunity.py) | true positive rate gap between groups |
| `equalized_odds` | Equalized Odds Difference | [EqualizedOdds](src\syntheval\metrics\fairness\metric_equalized_odds.py) | mean of the true and false positive rate gaps |
